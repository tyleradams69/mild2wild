...
async function loginAction(formData: FormData) {
  ...
  const resolved = resolveLoginSession({ role, staffSlug });
    ...
    <PageShell>
      <section className="mx-auto max-w-5xl px-5 py-16">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-white/65">
          Prototype login for the Mild 2 Wild portal. The owner/admin route signs an all-access session, while each employee login receives a session scoped to only their calendar.
        </p>
